...
final class X509HashValidationTests: XCTestCase {
    ...
    func testJwtX5cIntegration_ValidClientId() async throws {
        ...
        let jwtResult = await X5CJWTVerifier.verifyJwtWithX5C(jwt: jwt, issuerURL: nil, loteSearchInfos: [], verifyCertChain: true)
    ...
    func testJwtX5cIntegration_AttackerCertificate() async throws {
        ...
        let jwtResult = await X5CJWTVerifier.verifyJwtWithX5C(jwt: attackerJwt, issuerURL: nil, loteSearchInfos: [], verifyCertChain: true)
