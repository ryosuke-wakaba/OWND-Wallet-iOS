...
final class X509HashValidationTests: XCTestCase {
    ...
    func testJwtX5cIntegration_ValidClientId() async throws {
        ...
        let jwtResult = await X5CJWTVerifier.verifyJwtWithX5C(jwt: jwt, contextSearchInfos: [], verifyCertChain: true)
    ...
    func testJwtX5cIntegration_AttackerCertificate() async throws {
        ...
        let jwtResult = await X5CJWTVerifier.verifyJwtWithX5C(jwt: attackerJwt, contextSearchInfos: [], verifyCertChain: true)
